...
void
nrUeRrcProtocolIdeal::DoSendRrcResumeComplete (LteRrcSap::RrcResumeComplete msg)
{
  // initialize the RNTI and get the EnbLteRrcSapProvider for the
  // gNB we are currently attached to
  m_rnti = m_rrc->GetRnti ();
...
void
nrUeRrcProtocolIdeal::DoSendRrcResumeRequest (LteRrcSap::RrcResumeRequest msg)
{
  // initialize the RNTI and get the EnbLteRrcSapProvider for the
  // gNB we are currently attached to
  m_rnti = m_rrc->GetRnti ();
...
void
NrGnbRrcProtocolIdeal::DoSendRrcResume (uint16_t rnti, LteRrcSap::RrcResume msg)
{
  Simulator::Schedule (RRC_IDEAL_MSG_DELAY,
