...
private:
  ...
  /**
   * Trace to obtain Wideband CQI value from SINR received in UE
  */
  TracedCallback<uint16_t, uint16_t, uint8_t, uint8_t> m_reportWbCQI;

  /*
   * Trace to obtain RSRP value received in UE
  */
  TracedCallback<double, uint16_t, uint16_t> m_reportRsrp;
};
