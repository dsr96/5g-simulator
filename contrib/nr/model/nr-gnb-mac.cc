...
public:
  ...
  virtual void BeamChangeReport (BeamId beamId, uint16_t rnti) override;
...
void
NrMacEnbMemberPhySapUser::BeamChangeReport (BeamId beamId, uint16_t rnti)
{
...
void
NrGnbMac::BeamChangeReport (BeamId beamId, uint16_t rnti)
{
  NrMacCschedSapProvider::CschedUeConfigReqParameters params;
  params.m_rnti = rnti;
