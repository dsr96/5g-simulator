                                              ...
                                              uint8_t bwpId, Ptr<const NrControlMessage> msg)
{
  if (!m_rxedGnbMacCtrlMsgsFile.is_open ())
      {
        m_rxedGnbMacCtrlMsgsFileName = "RxedGnbMacCtrlMsgsTrace-NR.txt";
                                              ...
                                              uint8_t bwpId, Ptr<const NrControlMessage> msg)
{
  if (!m_txedGnbMacCtrlMsgsFile.is_open ())
      {
        m_txedGnbMacCtrlMsgsFileName = "TxedGnbMacCtrlMsgsTrace-NR.txt";
                                             ...
                                             uint8_t bwpId, Ptr<const NrControlMessage> msg)
{
  if (!m_rxedUeMacCtrlMsgsFile.is_open ())
      {
        m_rxedUeMacCtrlMsgsFileName = "RxedUeMacCtrlMsgsTrace-NR.txt";
                                             ...
                                             uint8_t bwpId, Ptr<const NrControlMessage> msg)
{
  if (!m_txedUeMacCtrlMsgsFile.is_open ())
      {
        m_txedUeMacCtrlMsgsFileName = "TxedUeMacCtrlMsgsTrace-NR.txt";
