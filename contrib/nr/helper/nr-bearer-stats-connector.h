...
public:
   ...
   */
  void EnableRlcStats (Ptr<NrBearerStatsCalculator> rlcStats, std::string node, std::string device);
   ...
   */
  void EnablePdcpStats (Ptr<NrBearerStatsCalculator> pdcpStats, std::string node, std::string device);

  /**
   * Connects trace sinks to appropriate trace sources
   */
  void EnsureConnected (std::string node, std::string device);
