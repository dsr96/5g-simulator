...
void
NrBearerStatsConnector::EnableRlcStats (Ptr<NrBearerStatsCalculator> rlcStats, std::string node, std::string device)
{
  m_rlcStats = rlcStats;
  EnsureConnected (node, device);
}

void
NrBearerStatsConnector::EnablePdcpStats (Ptr<NrBearerStatsCalculator> pdcpStats, std::string node, std::string device)
{
...
void
NrBearerStatsConnector::EnsureConnected (std::string node, std::string device)
{
  NS_LOG_FUNCTION (this);
  if (!m_connected)
    {
      Config::Connect ("/NodeList/"+node+"/DeviceList/"+device+"/LteEnbRrc/NewUeContext",
                       MakeBoundCallback (&NrBearerStatsConnector::NotifyNewUeContextEnb, this));
      Config::Connect ("/NodeList/"+node+"/DeviceList/"+device+"/LteUeRrc/RandomAccessSuccessful",
                       MakeBoundCallback (&NrBearerStatsConnector::NotifyRandomAccessSuccessfulUe, this));
      Config::Connect ("/NodeList/"+node+"/DeviceList/"+device+"/LteEnbRrc/ConnectionReconfiguration",
                       MakeBoundCallback (&NrBearerStatsConnector::NotifyConnectionReconfigurationEnb, this));
      Config::Connect ("/NodeList/"+node+"/DeviceList/"+device+"/LteUeRrc/ConnectionReconfiguration",
                       MakeBoundCallback (&NrBearerStatsConnector::NotifyConnectionReconfigurationUe, this));
      Config::Connect ("/NodeList/"+node+"/DeviceList/"+device+"/LteEnbRrc/HandoverStart",
                       MakeBoundCallback (&NrBearerStatsConnector::NotifyHandoverStartEnb, this));
      Config::Connect ("/NodeList/"+node+"/DeviceList/"+device+"/LteUeRrc/HandoverStart",
                       MakeBoundCallback (&NrBearerStatsConnector::NotifyHandoverStartUe, this));
      Config::Connect ("/NodeList/"+node+"/DeviceList/"+device+"/LteEnbRrc/HandoverEndOk",
                       MakeBoundCallback (&NrBearerStatsConnector::NotifyHandoverEndOkEnb, this));
      Config::Connect ("/NodeList/"+node+"/DeviceList/"+device+"/LteUeRrc/HandoverEndOk",
