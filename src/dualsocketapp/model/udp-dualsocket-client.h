...
#ifndef UDP_DUALSOCKET_CLIENT_H
#define UDP_DUALSOCKET_CLIENT_H
 ...
 */
class UdpDualSocketClient : public Application
{
public:
  /**
  ...
  /*
  * Callback: get NR gNB SINR (dB) value
  */
  static void UpdateGnbNrSinr (Ptr<UdpDualSocketClient> dsClient, std::string path, RxPacketTraceParams params);

  /*
  * Set SINR (dB) received in m_nrSinrValueReceived variable
  */
  void SetGnbNrSinrReceived (double sinr);
...
private:
  ...
  Ptr<LteUeNetDevice> m_netDeviceIndirect; //!< Indirect NetDevice

  EventId m_sendEvent; //!< Event to send the next packet
  double m_nrSinrValueReceived; //SINR received by callback, in dB
