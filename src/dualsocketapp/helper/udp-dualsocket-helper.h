 ...
 */
#ifndef UDP_DUALSOCKET_HELPER_H
#define UDP_DUALSOCKET_HELPER_H
 ...
 */
class UdpDualSocketServerHelper
{
public:
  /**
   * Create UdpDualSocketServerHelper which will make life easier for people trying
   * to set up simulations with echos.
   *
   * \param port The port the server will wait on for incoming packets
   */
  UdpDualSocketServerHelper (uint16_t port);
  ...
  /**
   * Create a UdpDualSocketServerApplication on the specified Node.
   *
  ...
  /**
   * Create a UdpDualSocketServerApplication on specified node
   *
 ...
 */
class UdpDualSocketClientHelper
{
public:
  /**
   * Create UdpDualSocketClientHelper which will make life easier for people trying
   * to set up simulations with echos.
   *
   * \param ip The IP address of the remote udp echo server
   * \param port The port number of the remote udp echo server
   */
  UdpDualSocketClientHelper (Address ip, uint16_t port);
  /**
   * Create UdpDualSocketClientHelper which will make life easier for people trying
   * to set up simulations with echos.
   *
   ...
   * \param port The port number of the remote udp echo server
   */
  UdpDualSocketClientHelper (Ipv4Address ip, uint16_t port);
  /**
   * Create UdpDualSocketClientHelper which will make life easier for people trying
   * to set up simulations with echos.
   *
   ...
   * \param port The port number of the remote udp echo server
   */
  UdpDualSocketClientHelper (Ipv6Address ip, uint16_t port);
