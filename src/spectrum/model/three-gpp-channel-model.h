...
private:
  ...
  double m_InFvolume; //Hall volume in m3 in factory scenarios for calculating the delay spread
  double m_InFTotalSurface; //Total surface area of hall in m2 (walls+floor+ceilling) in factory scenarios for calculating the delay spread
