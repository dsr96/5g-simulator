 ...
 * \ingroup propagation
 *
 * \brief Computes the channel condition for the Indoor Factory SL
 *
 * Computes the channel condition following the specifications for the
 * Indoor Factory SL scenario reported in Table 7.4.2-1 of 3GPP TR 38.901 v16.1.0
 */
class ThreeGppIndoorFactorySLChannelConditionModel : public ThreeGppChannelConditionModel
{
public:
  /**
   * Get the type ID.
  ...
  /**
   * Constructor for the ThreeGppIndoorFactorySLChannelConditionModel class
   */
  ThreeGppIndoorFactorySLChannelConditionModel ();

  /**
   * Destructor for the ThreeGppIndoorFactorySLChannelConditionModel class
   */
  virtual ~ThreeGppIndoorFactorySLChannelConditionModel () override;

private:
  /**
   * Compute the LOS probability as specified in Table 7.4.2-1 of 3GPP TR 38.901
   * for the Indoor Factory SL scenario.
   *
   * \param a tx mobility model
   * \param b rx mobility model
   * \return the LOS probability
   */
  virtual double ComputePlos (Ptr<const MobilityModel> a, Ptr<const MobilityModel> b) const override;
  double m_lowClutterDensity; //clutter density for (InF-SL, InF-SH)
};

/**
 * \ingroup propagation
 *
 * \brief Computes the channel condition for the Indoor Factory DL
 *
 * Computes the channel condition following the specifications for the
 * Indoor Factory DL scenario reported in Table 7.4.2-1 of 3GPP TR 38.901 v16.1.0
 */
class ThreeGppIndoorFactoryDLChannelConditionModel : public ThreeGppChannelConditionModel
{
public:
  /**
   * Get the type ID.
  ...
  /**
   * Constructor for the ThreeGppIndoorFactoryDLChannelConditionModel class
   */
  ThreeGppIndoorFactoryDLChannelConditionModel ();

  /**
   * Destructor for the ThreeGppIndoorFactoryDLChannelConditionModel class
   */
  virtual ~ThreeGppIndoorFactoryDLChannelConditionModel () override;

private:
  /**
   * Compute the LOS probability as specified in Table 7.4.2-1 of 3GPP TR 38.901
   * for the Indoor Factory DL scenario.
   *
   * \param a tx mobility model
   * \param b rx mobility model
   * \return the LOS probability
   */
  virtual double ComputePlos (Ptr<const MobilityModel> a, Ptr<const MobilityModel> b) const override;
  double m_highClutterDensity; //clutter density for (InF-DL, InF-DH)
};

/**
 * \ingroup propagation
 *
 * \brief Computes the channel condition for the Indoor Factory SH
 *
 * Computes the channel condition following the specifications for the
 * Indoor Factory SH scenario reported in Table 7.4.2-1 of 3GPP TR 38.901 v16.1.0
 */
class ThreeGppIndoorFactorySHChannelConditionModel : public ThreeGppChannelConditionModel
{
public:
  /**
   * Get the type ID.
  ...
  /**
   * Constructor for the ThreeGppIndoorFactorySHChannelConditionModel class
   */
  ThreeGppIndoorFactorySHChannelConditionModel ();

  /**
   * Destructor for the ThreeGppIndoorFactorySHChannelConditionModel class
   */
  virtual ~ThreeGppIndoorFactorySHChannelConditionModel () override;

private:
  /**
   * Compute the LOS probability as specified in Table 7.4.2-1 of 3GPP TR 38.901
   * for the Indoor Factory SH scenario.
   *
   * \param a tx mobility model
   * \param b rx mobility model
   * \return the LOS probability
  ...
  virtual double ComputePlos (Ptr<const MobilityModel> a, Ptr<const MobilityModel> b) const override;
  double m_lowClutterDensity; //clutter density for (InF-SL, InF-SH)
  double m_clutterHeight; //clutter height (m) < ceilling height (0-10) m
};

/**
 * \ingroup propagation
 *
 * \brief Computes the channel condition for the Indoor Factory DH
 *
 * Computes the channel condition following the specifications for the
 * Indoor Factory DH scenario reported in Table 7.4.2-1 of 3GPP TR 38.901 v16.1.0
 */
class ThreeGppIndoorFactoryDHChannelConditionModel : public ThreeGppChannelConditionModel
{
public:
  /**
   * Get the type ID.
  ...
  /**
   * Constructor for the ThreeGppIndoorFactoryDHChannelConditionModel class
   */
  ThreeGppIndoorFactoryDHChannelConditionModel ();

  /**
   * Destructor for the ThreeGppIndoorFactoryDHChannelConditionModel class
   */
  virtual ~ThreeGppIndoorFactoryDHChannelConditionModel () override;

private:
  /**
   * Compute the LOS probability as specified in Table 7.4.2-1 of 3GPP TR 38.901
   * for the Indoor Factory DH scenario.
   *
   * \param a tx mobility model
   * \param b rx mobility model
   * \return the LOS probability
