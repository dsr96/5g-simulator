...
double
ThreeGppV2vUrbanPropagationLossModel::GetPlTw (Ptr<MobilityBuildingInfo> a1, Ptr<MobilityBuildingInfo> b1) const
{
  NS_LOG_FUNCTION (this);
  NS_UNUSED (a1);
  NS_UNUSED (b1);
...
double
ThreeGppV2vUrbanPropagationLossModel::GetO2IStdDeviation (Ptr<MobilityBuildingInfo> a1, Ptr<MobilityBuildingInfo> b1) const
{
  NS_LOG_FUNCTION (this);
  NS_UNUSED (a1);
  NS_UNUSED (b1);
...
double
ThreeGppV2vUrbanPropagationLossModel::GetDistance2dIn () const
{
  NS_LOG_FUNCTION (this);
...
double
ThreeGppV2vHighwayPropagationLossModel::GetPlTw (Ptr<MobilityBuildingInfo> a1, Ptr<MobilityBuildingInfo> b1) const
{
  NS_LOG_FUNCTION (this);
  NS_UNUSED (a1);
  NS_UNUSED (b1);
...
double
ThreeGppV2vHighwayPropagationLossModel::GetO2IStdDeviation (Ptr<MobilityBuildingInfo> a1, Ptr<MobilityBuildingInfo> b1) const
{
  NS_LOG_FUNCTION (this);
  NS_UNUSED (a1);
  NS_UNUSED (b1);
...
double
ThreeGppV2vHighwayPropagationLossModel::GetDistance2dIn () const
{
  NS_LOG_FUNCTION (this);
