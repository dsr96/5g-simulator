  ...
  : NoBackhaulEpcHelper ()
{
  ...
  m_s1uIpv4AddressHelper.SetBase (m_s1uBaseAddress.c_str(), "255.255.255.252");
  m_s1apIpv4AddressHelper.SetBase (m_s1apBaseAddress.c_str(), "255.255.255.252");
}
...
PointToPointEpcHelper::GetTypeId (void)
{
  ...
  static TypeId tid = TypeId ("ns3::PointToPointEpcHelper")
    ...
    .AddAttribute ("S1uBaseAddress",
                   "Select S1u base Address",
                   StringValue ("10.0.0.0"),
                   MakeStringAccessor (&PointToPointEpcHelper::m_s1uBaseAddress),
                   MakeStringChecker ())
    .AddAttribute ("S1apBaseAddress",
                   "Select S1ap base Address",
                   StringValue ("11.0.0.0"),
                   MakeStringAccessor (&PointToPointEpcHelper::m_s1apBaseAddress),
                   MakeStringChecker ())
  ;
  return tid;
}
