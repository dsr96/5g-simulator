...
public:
  ...
  /**
   * \brief Powers the UE on. This function finds among the eNodeB set the most suitable
   * 		and camps on it by going from RRC state IDLE_START to IDLE_CAMPED_NORMALLY.
   * \param ueDevice the UE device to be powered
   *
   * By calling this, the UE will start the initial cell selection procedure at the
   * beginning of the simulation.
   *
   * \warning This function can only be used in the EPC-enabled simulation
   */
  void PowerOn (Ptr<NetDevice> ueDevice);

   /**
    * \brief Powers the ueDevices on. This function finds among the eNodeB set the most suitable
    * 		and camps on it by going from RRC state IDLE_START to IDLE_CAMPED_NORMALLY.
    * \param ueDevices the UE devices to be powered
    *
    * By calling this, the UE will start the initial cell selection procedure at the
    * beginning of the simulation.
    *
    * \warning This function can only be used in the EPC-enabled simulation
    */
  void PowerOn (NetDeviceContainer ueDevices);
    ...
    * \warning This function can only be used in the EPC-enabled simulation
    * */
  void PowerOn (Ptr<NetDevice> ueDevice, Ptr<NetDevice> enbDevice);

   /**
    * \brief Manual camping of the UEs in ueDevices on a given eNB.
    *
    * \param ueDevices UEs to be camped
    * \param enbDevice eNB on which the UEs are to be camped
    *
    * \warning This function can only be used in the EPC-enabled simulation
    * */
  void PowerOn (NetDeviceContainer ueDevices, Ptr<NetDevice> enbDevice);
