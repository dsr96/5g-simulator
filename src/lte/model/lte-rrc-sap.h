...
public:
  ...
  /// 5G RrcResume structure (Release 16 v16.2.0)
  struct RrcResume
  {
    uint8_t rrcTransactionIdentifier; ///< RRC transaction identifier
  };

  /// 5G RrcResumeComplete structure (Release 16 v16.2.0)
  struct RrcResumeComplete
  {
    uint8_t rrcTransactionIdentifier; ///< RRC transcation identifier
  };

  /// 5G RrcResumeRequest structure (Release 16 v16.2.0)
  struct RrcResumeRequest
  {
    uint32_t resumeIdentity; //identidad del UE, short-RNTI
    uint16_t resumeMac; //token autenticación
    //ResumeCause puesto por defecto en lte-rrc-header.cc
  };
};
...
public:
   ...
   */
   ...
   /**
    * \brief Send an _RRCResumeComplete_ message to the serving eNodeB/gNB
    *        during an RRC connection resume complete procedure
    *        (Section 5.3.13 of TS 38.331 v16.2.0).
    * \param msg the message
    */
   virtual void SendRrcResumeComplete (RrcResumeComplete msg) = 0;
   /**
    * \brief Send an _RRCResumeRequest_ message to the serving eNodeB/gNB
    *        during an RRC connection resume request procedure
    *        (Section 5.3.13 of TS 38.331 v16.2.0).
    * \param msg the message
    */
   virtual void SendRrcResumeRequest (RrcResumeRequest msg) = 0;
};
...
public:
  ...
  /**
   * \brief Receive an _RRCResume_ message from the serving eNodeB/gNB
   *        during an RRC connection resume procedure
   *        (Section 5.3.13 of TS 38.331 v16.2.0).
   * \param msg the message
   */
...
public:
  ...
  /**
   * \brief Send an _RRCResume_ message to the a UE
   *        during an RRC connection resume procedure
   *        (Section 5.3.13 of TS 38.331 v16.2.0).
   * \param msg the message
   */
...
public:
  ...
  /**
   * \brief Receive _RRCResumeComplete_ message from the UE RRC
   *        during an RRC connection resume complete procedure
   *        (Section 5.3.13 of TS 38.331 v16.2.0).
   * \param msg the message
   */
  virtual void RecvRrcResumeComplete (uint16_t rnti, RrcResumeComplete msg) = 0;

  /**
   * \brief Receive _RRCResumeRequest_ message from the UE RRC
   *        during an RRC connection resume request procedure
   *        (Section 5.3.13 of TS 38.331 v16.2.0).
   * \param msg the message
   */
...
public:
  ...
  virtual void SendRrcResumeComplete (RrcResumeComplete msg);
  virtual void SendRrcResumeRequest (RrcResumeRequest msg);
...
template <class C>
void
MemberLteUeRrcSapUser<C>::SendRrcResumeComplete (RrcResumeComplete msg)
{
...
template <class C>
void
MemberLteUeRrcSapUser<C>::SendRrcResumeRequest (RrcResumeRequest msg)
{
  m_owner->DoSendRrcResumeRequest (msg);
}
...
public:
  ...
  virtual void RecvRrcResume (RrcResume msg);
...
template <class C>
void
MemberLteUeRrcSapProvider<C>::RecvRrcResume (RrcResume msg)
{
...
public:
  ...
  virtual void SendRrcResume (uint16_t rnti, RrcResume msg);
...
template <class C>
void
MemberLteEnbRrcSapUser<C>::SendRrcResume (uint16_t rnti, RrcResume msg)
{
...
public:
  ...
  virtual void RecvRrcResumeComplete (uint16_t rnti, RrcResumeComplete msg);
  virtual void RecvRrcResumeRequest (uint16_t rnti, RrcResumeRequest msg);
...
template <class C>
void
MemberLteEnbRrcSapProvider<C>::RecvRrcResumeComplete (uint16_t rnti, RrcResumeComplete msg)
{
...
template <class C>
void
MemberLteEnbRrcSapProvider<C>::RecvRrcResumeRequest (uint16_t rnti, RrcResumeRequest msg)
{
