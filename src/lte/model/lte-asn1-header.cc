...
void Asn1Header::SerializeBitstring (std::bitset<24> data) const
{
  SerializeBitstring<24> (data);
}
...
Buffer::Iterator Asn1Header::DeserializeBitstring (std::bitset<24> *data, Buffer::Iterator bIterator)
{
  return DeserializeBitstring<24> (data,bIterator);
}
