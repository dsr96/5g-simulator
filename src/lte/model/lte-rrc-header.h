...
public:
  ...
  /**
  * Receives a RrcResume IE and stores the contents into the class attributes
  * @param msg The information element to parse
  */
  void SetMessage (LteRrcSap::RrcResume msg);

  /**
  * Returns a RrcResume IE from the values in the class attributes
  * @return A RrcResume, as defined in LteRrcSap
  */
  LteRrcSap::RrcResume GetMessage () const;
...
/**
* This class manages the serialization/deserialization of RrcResumeComplete IE
*/
...
public:
  ...
  /**
  * Receives a RrcResumeComplete IE and stores the contents into the class attributes
  * @param msg The information element to parse
  */
  void SetMessage (LteRrcSap::RrcResumeComplete msg);

  /**
  * Returns a RrcResumeComplete IE from the values in the class attributes
  * @return A RrcResumeComplete, as defined in LteRrcSap
  */
  LteRrcSap::RrcResumeComplete GetMessage () const;
...
public:
  ...
  /**
  * Receives a RrcResumeRequest IE and stores the contents into the class attributes
  * @param msg The information element to parse
  */
  void SetMessage (LteRrcSap::RrcResumeRequest msg);

  /**
  * Returns a RrcResumeRequest IE from the values in the class attributes
  * @return A RrcResumeRequest, as defined in LteRrcSap
  */
  LteRrcSap::RrcResumeRequest GetMessage () const;

private:
  std::bitset<16> m_resumeMac; ///< ResumeMAC-I
  std::bitset<32> m_resumeIdentity; ///< ResumeIdentity (ShortI-RNTI-Value)
  /// ResumeCause enumeration
  enum
  {
    EMERGENCY = 0, HIGHPRIORITYACCESS, MT_ACCESS,
    MO_SIGNALLING, MO_DATA, MO_VOICECALL, MO_VIDEOCALL, MO_SMS, RNA_UPDATE, MPS_PRIORITYACCESS, MCS_PRIORITYACCESS,
    SPARE1, SPARE2, SPARE3, SPARE4, SPARE5
  } m_resumeCause; ///< the resume cause
  std::bitset<1> m_spare; ///< spare bit
};
/**
