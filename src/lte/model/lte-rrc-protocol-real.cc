...
void
LteUeRrcProtocolReal::DoSendRrcResumeComplete (LteRrcSap::RrcResumeComplete msg)
{
  // re-initialize the RNTI and get the EnbLteRrcSapProvider for the
  // eNB we are currently attached to
  m_rnti = m_rrc->GetRnti ();
...
void
LteUeRrcProtocolReal::DoSendRrcResumeRequest (LteRrcSap::RrcResumeRequest msg)
{
  // re-initialize the RNTI and get the EnbLteRrcSapProvider for the
  // eNB we are currently attached to
  m_rnti = m_rrc->GetRnti ();
...
LteUeRrcProtocolReal::DoReceivePdcpSdu (LtePdcpSapUser::ReceivePdcpSduParameters params)
{
  ...
  LteRrcSap::RrcResume rrcResumeMsg;
  ...
  switch ( rrcDlDcchMessage.GetMessageType () )
    ...
    case 5:
      ...
      break;
    case 6: //ESTO MODIFICAR el numero, cuando se modifique el asn-1 de Dl-dcch y UL-dcch
      //RrcResume
...
void
LteEnbRrcProtocolReal::DoSendRrcResume (uint16_t rnti, LteRrcSap::RrcResume msg)
{
...
LteEnbRrcProtocolReal::DoReceivePdcpPdu (uint16_t rnti, Ptr<Packet> p)
{
  ...
  switch ( rrcUlCcchMessage.GetMessageType () )
    ...
    case 2:
      ...
      LteRrcSap::RrcResumeRequest rrcResumeRequestMsg;
...
LteEnbRrcProtocolReal::DoReceivePdcpSdu (LtePdcpSapUser::ReceivePdcpSduParameters params)
{
  ...
  LteRrcSap::RrcResumeComplete rrcResumeCompleteMsg;
  ...
  switch ( rrcUlDcchMessage.GetMessageType () )
    ...
    case 4:
      ...
      break;
    case 6: //MODIFICAR este numero cuando se modifique ASN-1 en UlDdch
      params.pdcpSdu->RemoveHeader (rrcResumeCompleteHeader);
      rrcResumeCompleteMsg = rrcResumeCompleteHeader.GetMessage ();
      m_enbRrcSapProvider->RecvRrcResumeComplete (params.rnti, rrcResumeCompleteMsg);
      break;
    }
}
