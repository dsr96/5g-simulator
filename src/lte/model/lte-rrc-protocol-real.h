...
private:
  ...
  /**
   * Send RRC resume complete function
   *
   * \param msg LteRrcSap::RrcResumeComplete
   */
  void DoSendRrcResumeComplete (LteRrcSap::RrcResumeComplete msg);
  /**
   * Send RRC resume request function
   *
   * \param msg LteRrcSap::RrcResumeRequest
   */
  void DoSendRrcResumeRequest (LteRrcSap::RrcResumeRequest msg);
...
private:
  ...
  /**
   * Send RRC resume function
   *
   * \param rnti the RNTI
   * \param msg LteRrcSap::RrcResume
   */
  void DoSendRrcResume (uint16_t rnti, LteRrcSap::RrcResume msg);
  /**
