...
void
EpcMmeApplication::DoNotifyConnectionRequest(uint64_t imsi)
{
	NS_LOG_FUNCTION (this << imsi);
  // \TODO: add parametrizable values to arguments 2 and 3 of AddBearers
  AddBearer (imsi, EpcTft::Default(), EpsBearer::NGBR_VIDEO_TCP_DEFAULT);
}
