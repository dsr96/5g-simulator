 ...
 * Edit: Basado en udp-echo-helper.h
 */
#ifndef UDP_DUALSOCKET5G_HELPER_H
#define UDP_DUALSOCKET5G_HELPER_H
 ...
 */
class UdpDualSocket5gServerHelper
{
public:
  /**
   * Create UdpDualSocket5gServerHelper which will make life easier for people trying
   * to set up simulations with echos.
   *
   * \param port The port the server will wait on for incoming packets
   */
  UdpDualSocket5gServerHelper (uint16_t port);
  ...
  /**
   * Create a UdpDualSocket5gServerApplication on the specified Node.
   *
  ...
  /**
   * Create a UdpDualSocket5gServerApplication on specified node
   *
 ...
 */
class UdpDualSocket5gClientHelper
{
public:
  /**
   * Create UdpDualSocket5gClientHelper which will make life easier for people trying
   * to set up simulations with echos.
   *
   * \param ip The IP address of the remote udp echo server
   * \param port The port number of the remote udp echo server
   */
  UdpDualSocket5gClientHelper (Address ip, uint16_t port);
  /**
   * Create UdpDualSocket5gClientHelper which will make life easier for people trying
   * to set up simulations with echos.
   *
   ...
   * \param port The port number of the remote udp echo server
   */
  UdpDualSocket5gClientHelper (Ipv4Address ip, uint16_t port);
  /**
   * Create UdpDualSocket5gClientHelper which will make life easier for people trying
   * to set up simulations with echos.
   *
   ...
   * \param port The port number of the remote udp echo server
   */
  UdpDualSocket5gClientHelper (Ipv6Address ip, uint16_t port);
